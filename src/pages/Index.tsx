            ...
            {[
              {
                title: "Реформер",
                highlight: true,
                pros: ["Работа с глубокими мышцами", "Силовая нагрузка без риска травм", "Коррекция осанки", "Безопасно при болях в спине", "Индивидуальная нагрузка", "Видимый результат за 5–8 занятий", "Эстетика и форма тела"],
              },
              {
                title: "Йога",
                highlight: false,
              ...
              <div key={title} className="rounded-2xl p-6 flex flex-col gap-4" style={{ background: highlight ? "var(--verve-dark)" : "rgba(0,0,0,0.06)", border: highlight ? "1px solid rgba(184,92,69,0.4)" : "1px solid rgba(0,0,0,0.08)" }}>
                ...
                <ul className="flex flex-col gap-2">
                  {pros?.map((p) => (
                    <li key={p} className="flex items-start gap-2 font-body text-sm" style={{ color: highlight ? "var(--verve-cream)" : "rgba(0,0,0,0.55)" }}>
